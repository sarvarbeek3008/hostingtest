...
from aiogramneww import sozlamalar
from button import asosiy,kiyimlar,kuzgi,kompyuter,bahorgi,qishgi,yozgi,texnika,televizor,maishiy,mevalar,asosiy,oziq_ovqat,sozlamalar1,sabzavotlar,fast_food,aksesuarlar
...
async def uzbek_menu(call: types.CallbackQuery):
    await call.message.answer("Quyidagi bo'limlardan birini tanlang // Xavfsizligingiz uchun iltimos kontaktingizni ulashing :", reply_markup=registratsiya)
